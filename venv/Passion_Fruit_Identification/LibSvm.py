...
class LibSvm(object):
    ...
    def CreateModel(self):
        ...
        convertedFeaturesArray = x.astype(np.float64)

        # dataset 1
        # X_train = convertedFeaturesArray[0:244]
        # X_test = convertedFeaturesArray[244:]
        # y_train = labelsArray[0:244]
        # y_test = labelsArray[244:]

        # dataset 2
        # X_train = convertedFeaturesArray[0:484]
        # X_test = convertedFeaturesArray[484:]
